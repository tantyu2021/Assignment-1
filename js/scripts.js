...
if (city == "San Diego") {
    window.console.log("Fill the application.");
}
// or
var city = prompt("Where do you live?");
if (city == "San Diego") {
    alert("Fill the application.");
}

//STEP 22 - Comparison and Logical operators, an application that evaluates to false and displays the result within the console window
let x = 5;
let y = 10;
window.console.log(x = y != true);
